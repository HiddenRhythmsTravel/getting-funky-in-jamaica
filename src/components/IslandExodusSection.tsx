        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="font-sans text-sm md:text-base text-[#FFFDF9]/80 leading-relaxed mb-8">
              Continue the rhythm in Trelawny, Jamaica. Experience more world-class music in a stunning beachfront resort setting for a few days.
            </p>
            
            <div className="space-y-6 mb-10">
              <div className="flex items-start gap-4 text-sm md:text-base">
                <Music size={20} className="text-[#D4AF37] shrink-0 mt-1" />
                <span className="font-medium leading-relaxed">Performances by Gov't Mule with special guest John Scofield. Warren Haynes, Moe, and Daniel Donato's Cosmic Country are all on the ticket as well.</span>
              </div>
              <div className="flex items-start gap-4 text-sm md:text-base">
                <MapPin size={20} className="text-[#D4AF37] shrink-0 mt-1" />
                <span className="font-medium leading-relaxed">The Hideaway at Royalton Bluewaters is located on the North side of Jamaica, 35 minutes from Montego Bay airport.</span>
              </div>
              <div className="flex items-start gap-4 text-sm md:text-base">
                <Waves size={20} className="text-[#D4AF37] shrink-0 mt-1" />
                <span className="font-medium leading-relaxed">The stage is set on the beautiful sandy beach, on the resort.</span>
              </div>
              <div className="flex items-start gap-4 text-sm md:text-base">
                <Utensils size={20} className="text-[#D4AF37] shrink-0 mt-1" />
                <span className="font-medium leading-relaxed">All meals and beverages included.</span>
              </div>
            </div>
          </motion.div>
