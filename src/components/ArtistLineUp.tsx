    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden glass-card rounded-2xl overflow-hidden flex flex-col border border-brand-white/10 hover:border-brand-gold/40 transition-all duration-300">
          <div className="artist-video-container h-[380px] relative overflow-hidden flex items-center justify-center bg-[#051F1B]">
            <video
              ref={videoRef}
          ...
          <div className="p-5 flex flex-col justify-between flex-grow bg-brand-green/20 border-t border-brand-white/5">
            <div>
              ...
              <div className="mt-3 text-[9px] text-brand-gold/90 font-bold uppercase tracking-wider flex items-center gap-1 hover:text-brand-white transition-colors duration-300">
                <span>Click here for artist info</span>
        ...
        <div className="absolute inset-0 w-full h-full backface-hidden rotate-y-180 glass-card rounded-2xl overflow-hidden border border-brand-gold/30 shadow-2xl flex flex-col justify-between">
          ...
          <div className="relative z-10 m-3 rounded-xl border border-brand-gold/25 p-5 flex flex-col justify-between h-[calc(100%-1.5rem)] bg-brand-green/10">
            ...
            {/* Footer Control */}
            <div className="pt-3 border-t border-brand-white/10 flex items-center justify-center gap-4">
              <a 
                href={artist.instagram}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <span className="font-sans text-[9px] text-brand-gold/60 hover:text-brand-gold transition-colors uppercase font-bold tracking-widest">
                Click to Flip Back
              </span>
            </div>
          </div>
